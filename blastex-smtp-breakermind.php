...
$m->addHostname("qflash.pl");
// Add smtp port
$m->addPort(25);
// Smtp server email
$m->addUser('boo@qflash.pl');
// Smtp server password
$m->addPassword("Password");

// Add from
$m->addFrom("boo@qflash.pl", "Ania Bez pic");
// Add to
$m->addTo("em@qflash.pl", "Maxiu");
// Add to
$m->addTo("em@breakermind.com", "Maxiu");

// Add Cc
$m->addCc("em@gmail.com", "Yahoo email");// 
// Add Bcc
$m->addBcc("em@hotmail.com", "No i działa");
$m->addBcc("em@outlook.com", "Benku");
